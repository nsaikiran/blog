...
If there is no ambiguity, we just need to execute. 
A junior engineer maybe given a clearly articulated task to "execute". The task may not have any ambiguity.
...
Take a problem, understand the context around it, list down any prerequisites (for you to know/understand).
Ask questions that can make you move forward (to product team for requirements etc)
List down the various possible paths we can take, along with their pros and cons and propose one.
Make such assumption explicit and clear so that all stakeholders are aligned.
With these, produce the tasks that can be executed.
